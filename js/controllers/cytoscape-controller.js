...
ndexApp.controller('cytoscapeController', ['ndexService', 'ndexUtility', 'sharedProperties', '$scope', '$routeParams', '$modal', function(ndexService, ndexUtility, sharedProperties, $scope, $routeParams, $modal) {
    var NETWORK_SECTION_ID = '#canvas';
